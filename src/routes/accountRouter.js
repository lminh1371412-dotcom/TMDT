...
const uploadFeedback = require('../config/uploadFeedback')
...
router.post('/feedback', authMiddleware.isLoggedIn, uploadFeedback.array('image'), accountController.sendFeedback)
